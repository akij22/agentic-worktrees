...
- **Child ticket**: an issue linked to the map as a GitHub sub-issue. Where sub-issues aren't enabled, use a task list in the map and put `Part of #<map>` at the top of the child body.
